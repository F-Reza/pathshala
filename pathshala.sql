...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2022 at 04:38 PM
...
INSERT INTO `cost` (`cost_id`, `title`, `amount`) VALUES
(2, 'Utility Bill', '2500'),
(3, 'WiFi Bill', '2500');
...
CREATE TABLE `course` (
  ...
  `course_teacher_day` varchar(255) NOT NULL,
  `course_teacher_evening` varchar(255) NOT NULL,
  `limits` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `course` (`c_id`, `course_title`, `course_teacher_day`, `course_teacher_evening`, `limits`) VALUES
(2, 'Web Programming', 'Farhan Morshed', 'Farhan Morshed', 10),
(3, 'Mobile Application', 'Farhan Morshed', 'Farhan Morshed', 10);
...
(5, 'Arko', 'Sewrapara, Mirpur', '01830996044', 'Mobile Application', 'Day', '10000', 'arko', '1', '2022-10-02 18:06:15');
...
--
ALTER TABLE `cost`
  MODIFY `cost_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `user_std`
  MODIFY `std_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
